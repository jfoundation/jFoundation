...
if ($normalize==1) array_push($stylesheets, 'normalize.css');
array_push($stylesheets, 'foundation.css');
if ($fontawesome==1) array_push($stylesheets, 'font-awesome.css');
array_push($stylesheets, 'site.css');
if ($fontawesome==1) array_push($stylesheets, 'site-font-awesome.css');
